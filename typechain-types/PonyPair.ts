...
export interface PonyPairInterface extends utils.Interface {
  contractName: "PonyPair";
  functions: {
...
export interface PonyPair extends BaseContract {
  contractName: "PonyPair";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PonyPairInterface;
