...
export interface PonyFactoryInterface extends utils.Interface {
  contractName: "PonyFactory";
  functions: {
...
export interface PonyFactory extends BaseContract {
  contractName: "PonyFactory";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PonyFactoryInterface;
