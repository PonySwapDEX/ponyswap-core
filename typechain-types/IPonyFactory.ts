...
export interface IPonyFactoryInterface extends utils.Interface {
  contractName: "IPonyFactory";
  functions: {
...
export interface IPonyFactory extends BaseContract {
  contractName: "IPonyFactory";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IPonyFactoryInterface;
