...
export interface IPonyPairInterface extends utils.Interface {
  contractName: "IPonyPair";
  functions: {
...
export interface IPonyPair extends BaseContract {
  contractName: "IPonyPair";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IPonyPairInterface;
